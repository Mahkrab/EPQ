...
| [S003](sources/003-muller-charypar-gross-particle-based-fluid-simulation.md) | Müller, Charypar and Gross (2003) | Peer-reviewed conference paper | Foundational source for particle-based, Smoothed Particle Hydrodynamics-style fluid simulation and neighbour interactions. | [Official / DOI](https://doi.org/10.2312/SCA03/154-159) |
...
| [S043](sources/043-nvidia-cuda-on-wsl.md) | NVIDIA (2026) | Official technical documentation | Primary reference for the Windows-driver, WSL 2 GPU interface and Linux CUDA Toolkit arrangement. | [Official documentation](https://docs.nvidia.com/cuda/wsl-user-guide/) |
| [S044](sources/044-nvidia-smi.md) | NVIDIA (2026) | Official technical documentation | Command reference for identifying and monitoring the NVIDIA GPU, driver and memory. | [Official documentation](https://docs.nvidia.com/deploy/nvidia-smi/index.html) |
| [S045](sources/045-nvidia-nvcc.md) | NVIDIA (2026) | Official technical documentation | Compiler reference for building CUDA C++ source with `nvcc`. | [Official documentation](https://docs.nvidia.com/cuda/cuda-compiler-driver-nvcc/) |
| [S046](sources/046-rust-cargo-build-scripts.md) | Rust Project Developers (n.d.) | Official software documentation | Build-system reference for compiling and linking native CUDA C++ components from a Rust package. | [Official documentation](https://doc.rust-lang.org/cargo/reference/build-scripts.html) |
| [S047](sources/047-microsoft-vscode-cpp-intellisense.md) | Microsoft (n.d.) | Official software documentation | Configuration reference for compiler and header discovery in VS Code C/C++ IntelliSense. | [Official documentation](https://code.visualstudio.com/docs/cpp/configure-intellisense) |
| [S048](sources/048-nvidia-cuda-linux-installation.md) | NVIDIA (2026) | Official technical documentation | Installation reference for CUDA Toolkit paths, symbolic links and environment configuration on Linux. | [Official documentation](https://docs.nvidia.com/cuda/cuda-installation-guide-linux/) |
| [S049](sources/049-nvidia-cuda-runtime-api.md) | NVIDIA (2026) | Official API reference | Runtime reference for device discovery, kernel execution, synchronisation and GPU memory transfers. | [Official documentation](https://docs.nvidia.com/cuda/cuda-runtime-api/) |
